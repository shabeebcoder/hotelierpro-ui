...
function AddPersonForm({ onSubmit, values, type }) {
    ...
    return (
        <>
            <Sheet
                SubmitButton={() => <Button form='addperson' className="capitalize">
                    {type === 'create'
                        ? 'create new person'
                        : 'update person'}
                </Button>}
                title={type === 'create' ? 'Add new person' : 'Update person'}
                Form={() => <Forms />}
                description="  This form is designed for entering vital details about
            individuals associated with your hotel or property."
                open={true}
            >
