            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Enter the unique room number or identifier for this particular room. It should be a distinct label for easy identification.                                            </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="m@google.com">Drinks</SelectItem>
                      <SelectItem value="m@support.com">Tour</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormDescription>
                    Choose the room type from predefined categories, such as "Standard," "Deluxe," "Suite," or any other room types offered by your property.                                            </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
